...
public abstract class InventoryItemRoot implements IInventory
{
	private String name;
	 ...
	 */
	public InventoryItemRoot(ItemStack stack, int size, String name)
	{
		this.name = name;
		INV_SIZE = size;
		invItem = stack;
	...
	public boolean isItemValidForSlot(int slot, ItemStack itemstack)
	{
		...
		return !(itemstack.getItem() instanceof ItemStoreThree);
	}
